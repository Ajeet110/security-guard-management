  ...
  const renderDashboard = () => (
    <>
      ...
      <div style={{
          ...
          <div className="lbl">
            ...
            <button 
              ...
              onClick={(e) => {
                ...
                alert('Add patrol feature coming soon!');
              }}
              style={{
                position: 'absolute',
                top: '12px',
        ...
        <div className="stat">
          <div className="lbl">
            <span>Guard Attendance (Today)</span>
            <button 
              className="btn-icon btn-sm"
              onClick={(e) => {
                e.stopPropagation();
          ...
          <div className="lbl">
            ...
            <button 
              ...
              onClick={(e) => {
                ...
                alert('Add incident feature coming soon!');
              }}
              style={{
                position: 'absolute',
                top: '12px',
      ...
      {isMobile ? (
        <>
            ...
            {activeTab === 'guards' && (
              <div style={{ padding: '20px' }}>
                ...
                <div style={{ fontSize: '14px', color: 'var(--t2)', marginBottom: '20px' }}>
                  Manage guards under your supervision
                </div>
                {myGuards.length > 0 ? (
                    ...
                    {myGuards.map(guard => (
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
                          <Avatar user={guard} size="md" online={guard.is_online} />
                          <div style={{ flex: 1 }}>
                            <div style={{ fontSize: '14px', fontWeight: 600 }}>{guard.name}</div>
                            <div style={{ fontSize: '12px', color: 'var(--t3)', fontFamily: 'monospace' }}>
                              {guard.user_id}
                            </div>
                          </div>
                          <span className={`badge ${guard.is_online ? 'badge-g' : 'badge-r'}`}>
                            {guard.is_online ? 'Online' : 'Offline'}
                          </span>
                        </div>
                        <div style={{ fontSize: '12px', color: 'var(--t2)' }}>
                          Location: {guard.location || 'Not assigned'} • Shift: {guard.shift || 'Day 6AM-2PM'}
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            {activeTab === 'reports' && (
              <div style={{ padding: '20px' }}>
                ...
                <div style={{ fontSize: '14px', color: 'var(--t2)', marginBottom: '12px' }}>
                  View attendance reports and guard analytics
                </div>
                <button
                  className="btn-s"
                  onClick={() => setShowRecycleBin(true)}
          ...
          <div className="bottom-nav">
            ...
            <div 
              className={`nav-btn ${activeTab === 'guards' ? 'active' : ''}`}
...
// Add User Modal Component for SupervisorDashboard
      ...
      <div className="modal">
        ...
        <div className="modal-body">
          <form onSubmit={handleSubmit}>
            ...
            {formData.role === 'Guard' && (
              <div style={{ marginBottom: '16px' }}>
                <label className="flbl">Assign to Supervisor</label>
                <select 
                  className="fselect"
